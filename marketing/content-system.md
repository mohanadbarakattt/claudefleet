...
1. **The Operator** — you, on camera or voiceover, screen-recording the
   actual product/site. The most trust-building format in the whole plan
   per the research (real screen recordings beat every other proof format
   in this niche). Use this for anything that could be read as a claim.
2. **Ava** — a stylized AI-avatar co-host character (faceless/avatar-style
   content, per the research pattern). Her role: react to and explain what
   ClaudeFleet does, narrate "how this works" segments, and voice the
   cheat-code/hype framing. She never says "I bought this and it made me
   money" — she's a guide/narrator character, not a customer.
2. **Skeptic** — a played character (you, a friend, or a UGC actor) doing a
